(function(){
  ...
  */
  ...
  console.log(cpfFormated(cleanCPF('101.123-131x32')));
  console.log(cpfFormated(cleanCPF('210.458.522-05')));
  console.log(cpfFormated(cleanCPF('735 500 794 - 22')));
  console.log(cpfFormated(cleanCPF('101.123-131x32')));
  ...
  */
  ...
  let tags = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';

  console.log(
    tags.replace(/<(\w+)>([\S\s]+)(<\/\1>)/g, function(total, part1, part2, part3){
      return `<${part1}> O texto dentro da tag "${part1}" é "${part2}"${part3} \n`;
    }
  ));
}());