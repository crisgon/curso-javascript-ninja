...
let sumfunc = function sumfunc (a, b) {
  return a + b;
};
...
console.log(`A soma de 2 e 4 é igual a ${sumfunc(2,4)}.`);
...
console.log(`O nome da função que faz a soma é ${sumfunc.name}.`);
...
// Opção otimizada utilizando switch

function otherCalculator(operator) {
...
console.log(otherCalculator('+')(30,40));