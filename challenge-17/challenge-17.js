(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Cristiano Gonçalves'));
  ...
  */
  ...
  let regexDate = /(de) (\w\w\w\w\w) (de)/g;
  ...
  */
  ...
  function replaceDate(text) {
    return text.replace(regexDate, function(total, matchUm, matchDois){
      return `/${getMonthNumber(matchDois)}/`;
    })
  }
